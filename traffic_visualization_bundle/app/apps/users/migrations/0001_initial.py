    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', '管理员'), ('user', '普通用户'), ('analyst', '数据分析师')], default='user', max_length=20, verbose_name='角色')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('login', '登录'), ('logout', '登出'), ('upload', '上传数据'), ('train', '训练模型'), ('predict', '执行预测'), ('export', '导出报告'), ('view', '查看页面')], max_length=20, verbose_name='操作类型')),
